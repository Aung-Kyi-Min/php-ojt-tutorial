      ...
      <div class="card-body">
        <form action="{{ route('students.store') }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" value="{{old('phone')}}" name="phone" id="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="phone">
            @error('phone')
                <span class="text-danger">{{ $message }}</span>
            @enderror
            </div>
            ...
            <div class=" form-outline mb-3">
                ...
                <textarea name="address" value="{{old('address')}}" id="address" rows="3" class="form-control @error('address') is-invalid @enderror " placeholder="address">
                </textarea>
            @error('address')
                <span class="text-danger">{{ $message }}</span>
            @enderror
