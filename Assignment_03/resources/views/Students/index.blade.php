    ...
    <div class="container mt-3 w-75">
        ...
        <div class="card mt-4">
            <div class="card-header">
                <h4>Students Lists
                    <form action="{{ route('students.search') }}" class="float-end" method="GET">
                        @csrf
                        <div class="input-group">
                            <input type="search" name="search" id="search" value="{{ old('search') }}" class="form-control rounded" placeholder="Search"
